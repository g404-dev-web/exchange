    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-10 offset-1">
                <h2 class="mb-5 text-center">L'espace Formateur</h2>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="nav-user" role="tabpanel" aria-labelledby="nav-user-tab">
                        <div class="row">
                            @foreach($fabricsAdmin as $fabricAdmin)
                                <div class="col-6">
                                    <h4 class="text-center my-5">Simploniens de la fabrique {{ $fabricAdmin->name }}</h4>
                                    <table class="table">
                                        ...
                                        @foreach($users as $user)
                                            <tr>
                                                ...
                                                <td class="icon align-middle" style="text-align: center;">
                                                    <a href="/admin/users/{{ $user->id }}/login"><i class="fas fa-user-ninja"></i></a>
                                                </td>
                                                <td class="icon align-middle" style="text-align: center;">
                                                    <a href="/admin/users/{{ $user->id }}/delete"><i class="fas fa-user-times"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                ...
                                <ul class="list-group col-4 mb-3">
                                    @foreach ($chunk as $fabric)
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center ">
                                            {{ $fabric->name }}
                                            <span class="badge badge-dark badge-pill">{{ $fabric->users->count() }}</span>
                                        </li>
                                    @endforeach
                                </ul>
                            @endforeach
