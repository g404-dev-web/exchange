...
<script>
    ...
    function sendTokenToServer(token, params) {
        ...
        if(params.type === "all") {
            $('#registerForm').append('<input type="hidden" name="token_firebase" value="'+token+'">');
        }
        // else if (params.type === "all" && !checkbox) {
        //     $('#registerForm').append('<input type="hidden" name="token_firebase" value="">');
        // }
        // type === question
        else {
